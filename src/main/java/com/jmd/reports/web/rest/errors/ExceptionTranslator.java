package com.jmd.reports.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.jmd.reports.service.EmailAlreadyUsedException ||
            ex instanceof com.jmd.reports.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof com.jmd.reports.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.jmd.reports");
    }
}
